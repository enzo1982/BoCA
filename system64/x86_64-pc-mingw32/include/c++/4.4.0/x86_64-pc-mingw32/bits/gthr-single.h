...
static inline int 
__gthread_once (__gthread_once_t *once _GLIBCXX_UNUSED, void (*func) (void) _GLIBCXX_UNUSED)
{
  return 0;
}
  
static inline int _GLIBCXX_UNUSED
__gthread_key_create (__gthread_key_t *key _GLIBCXX_UNUSED, void (*func) (void *) _GLIBCXX_UNUSED)
{
  return 0;
}

static int _GLIBCXX_UNUSED
__gthread_key_delete (__gthread_key_t key _GLIBCXX_UNUSED)
{
  return 0;
}
  
static inline void *
__gthread_getspecific (__gthread_key_t key _GLIBCXX_UNUSED)
{
  return 0;
}

static inline int 
__gthread_setspecific (__gthread_key_t key _GLIBCXX_UNUSED, const void *v _GLIBCXX_UNUSED)
{
  return 0;
}

static inline int
__gthread_mutex_destroy (__gthread_mutex_t *mutex _GLIBCXX_UNUSED)
{
  return 0;
}

static inline int
__gthread_mutex_lock (__gthread_mutex_t *mutex _GLIBCXX_UNUSED)
{
  return 0;
}

static inline int
__gthread_mutex_trylock (__gthread_mutex_t *mutex _GLIBCXX_UNUSED)
{
  return 0;
}

static inline int
__gthread_mutex_unlock (__gthread_mutex_t *mutex _GLIBCXX_UNUSED)
{
  return 0;
}
