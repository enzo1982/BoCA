...
const String &BoCA::M3UPlaylist::GetComponentSpecs()
{
...
Bool BoCA::M3UPlaylist::CanOpenFile(const String &file)
{
...
const Array<BoCA::Track> &BoCA::M3UPlaylist::ReadPlaylist(const String &file)
{
...
Error BoCA::M3UPlaylist::WritePlaylist(const String &file)
{
