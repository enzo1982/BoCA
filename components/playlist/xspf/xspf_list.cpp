...
const String &BoCA::XSPFPlaylist::GetComponentSpecs()
{
...
namespace BoCA
{
	class XSPFPlaylistCallback : public XspfReaderCallback
	{
		private:
			XSPFPlaylist	*playlist;
		public:
					 XSPFPlaylistCallback(XSPFPlaylist *);

			void		 addTrack(XspfTrack *);
 	};
};

BoCA::XSPFPlaylist::XSPFPlaylist()
{
}
...
Bool BoCA::XSPFPlaylist::CanOpenFile(const String &file)
{
	return file.ToLower().EndsWith(".xspf");
}

const Array<BoCA::Track> &BoCA::XSPFPlaylist::ReadPlaylist(const String &file)
{
	 ...
	 */
	XspfReader		 reader;
	XSPFPlaylistCallback	 callback(this);
...
Error BoCA::XSPFPlaylist::WritePlaylist(const String &file)
{
...
String BoCA::XSPFPlaylist::EncodeURI(const String &uri)
{
...
String BoCA::XSPFPlaylist::DecodeURI(const String &uri)
{
...
BoCA::XSPFPlaylistCallback::XSPFPlaylistCallback(XSPFPlaylist *playlist)
{
	this->playlist = playlist;
}

void BoCA::XSPFPlaylistCallback::addTrack(XspfTrack *xspfTrack)
{
