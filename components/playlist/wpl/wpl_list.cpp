...
const String &BoCA::WPLPlaylist::GetComponentSpecs()
{
...
Bool BoCA::WPLPlaylist::CanOpenFile(const String &file)
{
...
const Array<BoCA::Track> &BoCA::WPLPlaylist::ReadPlaylist(const String &file)
{
...
Error BoCA::WPLPlaylist::WritePlaylist(const String &file)
{
