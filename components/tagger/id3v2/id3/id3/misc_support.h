...
//following routine courtesy of John George
ID3_Frame* ID3_AddGenre(ID3_Tag*, const char *, bool replace = false);
...
//following routine courtesy of John George
int ID3_GetPictureData(const ID3_Tag*, const char* TempPicPath);

//following routine courtesy of John George
char* ID3_GetPictureMimeType(const ID3_Tag*);

//following routine courtesy of John George
bool ID3_HasPicture(const ID3_Tag*);

//following two routines courtesy of John George
ID3_Frame* ID3_AddPicture(ID3_Tag*, const char* TempPicPath, const char* MimeType, bool replace = false);
ID3_Frame* ID3_AddPicture(ID3_Tag*, const char* TempPicPath, const char* MimeType, ID3_PictureType pictype, const char* Description, bool replace = false);

//following routine courtesy of John George
size_t ID3_RemovePictures(ID3_Tag*);

//following routine courtesy of John George
size_t ID3_GetPictureDataOfPicType(ID3_Tag*, const char* TempPicPath, ID3_PictureType pictype);

//following routine courtesy of John George
char *ID3_GetMimeTypeOfPicType(ID3_Tag*, ID3_PictureType pictype);

//following routine courtesy of John George
char *ID3_GetDescriptionOfPicType(ID3_Tag*, ID3_PictureType pictype);

//following routine courtesy of John George
size_t ID3_RemovePictureType(ID3_Tag*, ID3_PictureType pictype);

ID3_Frame* ID3_AddGenre(ID3_Tag* tag, size_t genreNum, char* genre, bool add_v1_genre_number = true, bool add_v1_genre_description = true, bool addRXorCR = false, bool replace = true);
