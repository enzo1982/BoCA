...
#include "tocplist_tag.h"

using namespace smooth::IO;

const String &BoCA::TOCPListTag::GetComponentSpecs()
{
...
Error BoCA::TOCPListTag::ParseStreamInfo(const String &fileName, Track &track)
{
...
Bool BoCA::TOCPListTag::ReadSessions(XML::Node *sessions, Buffer<UnsignedByte> &mcdi, Int32 &leadOut)
{
...
Bool BoCA::TOCPListTag::ReadSession(XML::Node *session, Buffer<UnsignedByte> &mcdi, Int32 &leadOut)
{
...
Bool BoCA::TOCPListTag::ReadTracks(XML::Node *tracks, Buffer<UnsignedByte> &mcdi)
{
...
Bool BoCA::TOCPListTag::ReadTrack(XML::Node *track, Buffer<UnsignedByte> &mcdi)
{
	Bool	 data	 = False;
	Bool	 preemp	 = False;
	Int	 number	 = 0;
