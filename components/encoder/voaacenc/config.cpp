...
BoCA::ConfigureVOAAC::ConfigureVOAAC()
{
	...
	i18n->SetContext("Encoders::VOAACEnc");

	group_id3v2		= new GroupBox(i18n->TranslateString("Info tags"), Point(7, 143), Size(281, 90));
	...
	SetSize(Size(group_id3v2->GetWidth() + 14, 240));
}
