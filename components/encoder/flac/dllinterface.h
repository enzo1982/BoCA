...
typedef FLAC__bool 				(*FLAC__METADATA_OBJECT_SEEKTABLE_TEMPLATE_APPEND_SPACED_POINTS_BY_SAMPLES)	(FLAC__StreamMetadata *, unsigned, FLAC__uint64);
...
extern FLAC__METADATA_OBJECT_SEEKTABLE_TEMPLATE_APPEND_SPACED_POINTS_BY_SAMPLES	 ex_FLAC__metadata_object_seektable_template_append_spaced_points_by_samples;
