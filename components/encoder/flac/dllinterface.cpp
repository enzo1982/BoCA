...
FLAC__METADATA_OBJECT_SEEKTABLE_TEMPLATE_APPEND_SPACED_POINTS_BY_SAMPLES	 ex_FLAC__metadata_object_seektable_template_append_spaced_points_by_samples	= NIL;
...
Bool LoadFLACDLL()
{
	...
	ex_FLAC__metadata_object_seektable_template_append_spaced_points_by_samples	= (FLAC__METADATA_OBJECT_SEEKTABLE_TEMPLATE_APPEND_SPACED_POINTS_BY_SAMPLES) flacdll->GetFunctionAddress("FLAC__metadata_object_seektable_template_append_spaced_points_by_samples");
	...
	if (ex_FLAC_API_SUPPORTS_OGG_FLAC						== NIL ||
	    ...
	    ex_FLAC__metadata_object_seektable_template_append_spaced_points_by_samples	== NIL ||
