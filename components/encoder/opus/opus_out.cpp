...
const String &BoCA::OpusOut::GetComponentSpecs()
{
...
Int BoCA::OpusOut::WriteData(Buffer<UnsignedByte> &data, Int size)
{
...
Int BoCA::OpusOut::EncodeFrames(const Buffer<signed short> &samplesBuffer, Buffer<unsigned char> &dataBuffer, Bool flush)
{
...
Int BoCA::OpusOut::WriteOggPackets(Bool flush)
{
	Int	 bytes = 0;
