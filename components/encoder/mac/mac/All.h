...
#define MAC_VERSION_STRING                              _T("4.70")
#define MAC_NAME                                        _T("Monkey's Audio 4.70")
#define PLUGIN_NAME                                     "Monkey's Audio Player v4.70"
#define MJ_PLUGIN_NAME                                  _T("APE Plugin (v4.70)")
#define CONSOLE_NAME                                    _T("--- Monkey's Audio Console Front End (v 4.70) (c) Matthew T. Ashland ---\n")
#define PLUGIN_ABOUT                                    _T("Monkey's Audio Player v4.70\nCopyrighted (c) 2000-2019 by Matthew T. Ashland")
