...
const String &BoCA::QSAOut::GetComponentSpecs()
{
...
Int BoCA::QSAOut::WriteData(Buffer<UnsignedByte> &data, Int size)
{
...
Int BoCA::QSAOut::SetPause(Bool pause)
{
