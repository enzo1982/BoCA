...
const String &BoCA::CDIOIn::GetComponentSpecs()
{
...
Void smooth::AttachDLL(Void *instance)
{
	...
	const Array<String>	&driveNames = BoCA::CDIOIn::FindDrives();
...
Bool BoCA::CDIOIn::CanOpenStream(const String &streamURI)
{
...
Error BoCA::CDIOIn::GetStreamInfo(const String &streamURI, Track &track)
{
